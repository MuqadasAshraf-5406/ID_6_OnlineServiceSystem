...
(1, 'Muqadas', 'admin@gmail.com', '123456');
...
(6, 49, 'Mic not working', 'my mic is not working', 'Sadaf', '6565', 'Col', 'Karachi', 'Sindh', 6565, 'sadaf@gmail.com', 656567, 'Rohail', '2022-01-14'),
(7, 50, 'Jack and Jones', 'Hello There have you seen this movie', 'Ahmed', '123', 'DHA Phase1', 'Lahore', 'Punjab', 123456, 'ahmed@gmail.com', 234234234, 'Abdullah', '2022-01-16'),
(8, 50, 'Jack and Jones', 'Hello There have you seen this movie', 'Badar', '123', 'Dhase Phase2', 'Islamabad', 'Punjab', 123456, 'badar@gmail.com', 234234234, 'Jihan', '2021-10-21'),
(9, 52, 'LCD Not working', 'my lcd is not working properly', 'Iman', 'House No. 123', 'Stadium Road', 'Karachi', 'Sindh', 12345, 'iman@gmail.com', 234566, 'Ayan', '2021-02-21'),
(10, 52, 'Rode Mic Note Working', 'my rode mic is not working properly', 'Saira', 'House no 234', 'Malir', 'Karachi', 'Sindh', 674534, 'saira@gmail.com', 1234566782, 'Saad', '2021-08-21');
...
(1, 'Sahil', 'Bokaro', 'Mouse', 1, 600, 600, '2018-10-13'),
(2, 'Rohan', 'Ranchi', 'Mouse', 2, 600, 600, '2018-10-13'),
(3, 'Hasnain', 'Bokaro', 'Mouse', 5, 600, 3000, '2018-10-13'),
(4, 'Zeeshan', 'Ranchi', 'Mouse', 2, 600, 1200, '2018-10-13'),
(5, 'Ibrahim', 'add1', 'Mouse', 1, 600, 600, '2020-10-13'),
(6, 'Mehdi', 'add2', 'Keyboard', 1, 500, 500, '2022-01-13'),
(7, 'Sadia', 'add3', 'Keyboard', 1, 500, 500, '2021-10-09'),
(8, 'Sadaf', 'add4', 'Keyboard', 2, 500, 1000, '2022-02-21'),
(9, 'Kashaf', 'add5', 'Keyboard', 1, 500, 500, '2022-01-20'),
(10, 'wajiha', 'add6', 'Keyboard', 1, 500, 500, '2022-01-20'),
(11, 'Rumaisa', 'add7', 'Samsung LCD', 1, 12000, 12000, '2022-01-20'),
(19, 'Zobia', 'add8', 'Keyboard', 1, 500, 500, '2022-10-20'),
(20, 'Asad', 'add9', 'Keyboard', 1, 500, 500, '2022-10-20'),
(21, 'Raniya', 'add10', 'Samsung LCD', 1, 12000, 12000, '2022-10-20'),
(22, 'xyz', 'add11', 'Samsung LCD', 1, 12000, 12000, '2022-10-20'),
(23, 'Rahaab', 'add12', 'Samsung LCD', 1, 12000, 12000, '2022-10-20'),
(24, 'Ahmed', 'add13', 'Samsung LCD', 1, 12000, 12000, '2022-10-20'),
(25, 'Badar', 'add14', 'Mouse', 1, 600, 600, '2021-10-20'),
(26, 'Iman', 'add15', 'Samsung LCD', 1, 12000, 12000, '2020-10-20'),
(27, 'Saira', 'add16', 'Mouse', 1, 600, 600, '2022-10-20'),
(28, 'Ahmed', 'add17', 'Rode Mic', 1, 18000, 18000, '2021-10-20');
...
(9, ' Ahmed', 'ahmed@gmail.com', 'osms'),
(10, '  User', 'user@gmail.com', 'user'),
(11, 'Sadaf', 'sadaf@gmail.com', 'qwerty');
...
(50, 'Jack and Jones', 'Hello There have you seen this movie', 'Ahmed', '123', 'DHA Phase1', 'Islamabad', 'Punjab', 123456, 'ahmed@gmail.com', 234234234, '2021-10-13'),
(51, 'asdsadsa', 'asdsadsa', 'Raniya', 'asdasd', 'xyz', 'Lahore', 'Punjab', 1413123, 'userXYZ@gmail.com', 4131323, '2022-10-20'),
(52, 'Rode Mic Note Working', 'my rode mic is not working properly', 'Sadaf', 'house no 234', 'Sec 3', 'Karachi', 'Sindh', 674534, 'user@gmail.com', 1234566782, '2022-10-20'),
(53, 'keyboard not working', 'keyboard not working due to crash', 'Muqadas', 'add 1', 'add 2', 'Karachi', 'Sindh', 24453656, 'ahmed@gmail.com', 25566652, '2022-01-12'),
(54, 'hard drive is not working', 'hard drive crashes', 'Muqadas', '1234', '123', 'Islamabad', 'Punjab', 27355, 'ahmed@gmail.com', 93884767482, '2021-12-14');
...
(12, 'Rohail', 'Karachi', 1234, 'techRohail@gmail.com');
