...
<body>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <p>
        OSMS Services is Pakistan’s leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Soha Ali</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        <strong>City Branch:</strong> <br>
        OSMS Pvt Ltd, <br>
        Sec IV, Gulshan-e-Iqal <br>
        Karachi - 834005 <br>
        Phone: +0345678 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>

        <br><br>
        <strong>Islamabad Branch:</strong> <br>
        OSMS Pvt Ltd, <br>
        ZoneIII, Islamabad <br>
        Islamabad - 804002 <br>
        Phone: +00000000 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>
